  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-gray-500 to-gray-300 px-6 py-12 lg:px-8 overflow-y-hidden">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
        <img className="mx-auto h-16 w-auto mb-6" src="asd.jpeg" alt="Your Company Logo" />

        <h2 className="text-center text-2xl font-bold text-gray-900 mb-4">Crear una cuenta</h2>
